...
%}
%name parse
%token  AUTO BREAK  CASE CHAR  CONST  CONTINUE  DEFAULT  DO DOUBLE  ELSE ENUM  GET  SHOW
...
primary_expression
	...
	| SHOW primary_expression { makeList("show", 'k', lineCount);  }
	| GET primary_expression { makeList("get", 'k', lineCount);  }
...
assignment_expression
	: conditional_expression {}
	| unary_expression assignment_operator assignment_expression { checkType($1,$3,lineCount);}
	;
